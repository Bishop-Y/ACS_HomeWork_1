...
> * В программе на ассемблере итерируемые переменные были заменены на регистры r12d, r13d, r14d и r15d. За счёт этого программа стала работать быстрее в ~2 раза. 
> * [Тесты](https://github.com/Bishop-Y/ACS_HomeWork_1/blob/main/Tests.md) <br/>
